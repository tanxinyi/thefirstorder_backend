...
DROP TABLE IF EXISTS Food_Price CASCADE;
...
DROP TABLE IF EXISTS Seating_Table CASCADE;
...
DROP TABLE IF EXISTS Manager_Allocation CASCADE;
...
DROP TABLE IF EXISTS Customisation_Option CASCADE;
...
DROP TABLE IF EXISTS Customisation_Selected CASCADE;
